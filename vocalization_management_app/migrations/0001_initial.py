    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audio_file', models.FileField(max_length=255, upload_to=vocalization_management_app.models.audio_file_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['wav'])])),
                ...
                ('analysis_excel', models.FileField(blank=True, null=True, upload_to='analysis_excel/')),
                ('duration_seconds', models.FloatField(blank=True, default=0.0, null=True)),
                ('duration', models.CharField(blank=True, max_length=20, null=True)),
                ('sample_rate', models.IntegerField(blank=True, null=True)),
                ('animal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='original_audio', to='vocalization_management_app.animaltable')),
                ('uploaded_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='uploaded_audio', to='vocalization_management_app.adminprofile')),
                ('zoo', models.ForeignKey(blank=True, choices=[('Breadsly_zoo', 'Breadsly Zoo')], null=True, on_delete=django.db.models.deletion.CASCADE, related_name='original_audio', to='vocalization_management_app.zoo')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detected_noise_file_path', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            name='AutoDetectedNoiseAudioFile',
            fields=[
                ('detected_noise_file_id', models.AutoField(primary_key=True, serialize=False)),
                ...
                ('upload_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('original_file', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auto_detected_noises', to='vocalization_management_app.originalaudiofile')),
            ],
        ),
        migrations.CreateModel(
            name='ProcessingLog',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clip_start_time', models.FloatField(blank=True, null=True)),
                ('clip_end_time', models.FloatField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('audio_file', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stfts', to='vocalization_management_app.originalaudiofile')),
                ('generated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='vocalization_management_app.staffprofile')),
            ],
        ),
        migrations.CreateModel(
